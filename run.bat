...
:: update.jsÎ•?update-run.jsÎ°?Î≥µÏÇ¨
copy "update.js" "update-run.js"
 
:: Î≥µÏÇ¨???åÏùºÎ°??ÖÎç∞?¥Ìä∏ ?§Ìñâ
...
echo.
:: config.js?êÏÑú ?¨Ìä∏ Ï∂îÏ∂ú (Î¨∏Ïûê???åÏã±)
